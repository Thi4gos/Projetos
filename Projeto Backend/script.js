...
loginInput.addEventListener('input', function () {
    if (!/^[a-zA-Z]{6}$/.test(this.value)) {
        errorLoginParagraph.textContent = 'O login deve ter exatamente 6 caracteres alfabéticos.';
    } else {
...
senhaInput.addEventListener('input', function () {
    if (!/^[a-zA-Z]{8}$/.test(this.value)) {
        errorSenhaParagraph.textContent = 'A senha deve ter exatamente 8 caracteres alfabéticos.';
    } else {
